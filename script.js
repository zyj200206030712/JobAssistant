...
const INTERVIEW_STATUSES = new Set(["测评", "笔试", "AI面试", "一面", "二面", "终面"]);
const ACTIONED_STATUSES = new Set(["已投递", "测评", "笔试", "AI面试", "一面", "二面", "终面", "Offer", "未通过"]);
...
function normalizeImportedCompanies(records) {
  ...
  const validStatuses = new Set(["未开启", "未关注", "不感兴趣", "待投递", "已投递", "测评", "笔试", "AI面试", "一面", "二面", "终面", "Offer", "未通过"]);
  return records.map((record, index) => {
